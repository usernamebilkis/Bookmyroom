...
class recycel : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listofdata.add(manually(R.drawable.hotelyogiexecutive,"Yogi Executive","Plot No 31/A, Sector 22, MAFCO Rd, opposite MAFCO Market, Sector 22, Vashi, Navi Mumbai, Maharashtra 400703"))
        listofdata.add(manually(R.drawable.hotelpalmbech,"Hotel Palm Beach Pride","Mahesh Building, A-Wing Sector 15, Plot no 37 Near Croma, Palm Beach Road CBD Belapur Navi Mumbai-400-614"))
        listofdata.add(manually(R.drawable.hotelcoroprtaed,"Hotel Corporate","11-Sai Sagar Building, Plot No. 69 Sector-15, CBD, Belapur, CBD Belapur, Navi Mumbai"))
//        listofdata.add(manually(R.drawable.imagefour,"Centre Point Navi Mumbai","DC-1 MIDC Industrial Area, Thane- Belapur Road, Turbhe Naka, Vashi, Navi Mumbai"))
        listofdata.add(manually(R.drawable.hoteyogi,"Yogi Metropolitan Hotel","Plot No. 4, Sector 23, Opp. Sanpada Rly. Stn. Sanpada, Navi Mumbai - 400 706 Maharashtra, Vashi, Navi Mumbai"))
